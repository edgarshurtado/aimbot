...
def test_startup_recovery_multiple_users(mocker):
    ...
    mock_repo.get_all_users.return_value = [
        User(
            ...
            password="pw",
            booking_goals=[
                BookingGoal(class_start=datetime(2027, 3, 15, 18, 30), class_name="WOD"),
                BookingGoal(class_start=datetime(2027, 3, 16, 10, 0), class_name="OPEN"),
            ],
        ),
        User(
            id=2,
            ...
            password="pw2",
            booking_goals=[
                BookingGoal(class_start=datetime(2027, 3, 17, 9, 0), class_name="GYMNASTIC"),
            ],
        ),
    ]
